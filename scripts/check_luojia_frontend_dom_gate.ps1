...
Require-Contains -Text $text -Pattern 'data-regional-terrain-installed="true"' -Label "regional terrain context installed"
...
Require-Contains -Text $text -Pattern "data-regional-3d-view-button" -Label "regional 3D view button"
